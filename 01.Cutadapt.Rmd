...
```{r}
In_path <- "../FASTQ/Project00"
out_path <- "~/ksy/project/Project00/Cutadapt"
FWD <- "AGAGTTTGATCCTGGCTCAG" # 8F
REV <- "ATTACCGCGGCTGCTGG"    # 534R
...
Cutadapt <- function(In_path, out_path, FWD, REV, QC = 20) {
  dir.create("../cutadapt/") 
  # import data
  ...
  system2(cutadapt, args = c(R1.flags, R2.flags, "-n", 2, # -n 2 required to remove FWD and REV from reads
                             ...
                             "-Q", QC, "-q",  20, "--minimum-length 20 --discard-untrimmed",
                             fnFs[i], fnRs[i],
